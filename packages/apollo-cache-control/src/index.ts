...
export const plugin = (
  ...
  requestDidStart(requestContext) {
    ...
    const hints: Map<ResponsePath, CacheHint> = new Map();

    function addHint(path: ResponsePath, hint: CacheHint) {
    ...
    function computeOverallCachePolicy(): Required<CacheHint> | undefined {
